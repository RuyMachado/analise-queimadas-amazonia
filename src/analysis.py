...
# Data Loading
df = pd.read_csv("../data/processed/inpe_data_processed.csv", sep = ";")


# Data Filtering
df_with_degradation = df[df["category"]=="with_degradation"]


# Data Aggregation
df_grouped = df_with_degradation.groupby(["category", "Year"])["D_Area"].sum()
